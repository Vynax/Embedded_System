...
static void usb_mouse_irq(struct urb *urb)
{
	...
	int status;
	//printk(KERN_INFO "Hello usbmouse irq 109598085 !\n");
	...
	input_report_key(dev, BTN_SIDE, data[0] & 0x01);
...
static int usb_mouse_open(struct input_dev *dev)
{
	...
	printk(KERN_INFO "Hello usbmouse open 109598085 !\n");
...
static void usb_mouse_close(struct input_dev *dev)
{
	...
	printk(KERN_INFO "Hello usbmouse close 109598085 !\n");
